...
export function SiteFooter({
  ...
  const guides = [
    [routes.checkpointGuide, nav.checkpointGuide],
    [routes.anomalies, nav.anomalies],
    [routes.medicalTests, nav.medicalTests],
    [routes.quarantine, nav.quarantine],
    [routes.walkthrough, nav.walkthrough],
  ] as const;
