...
export function SiteHeader({
  ...
  const guides = [
    [navigationRoutes.checkpointGuide, nav.checkpointGuide],
    [navigationRoutes.anomalies, nav.anomalies],
    [navigationRoutes.medicalTests, nav.medicalTests],
    [navigationRoutes.quarantine, nav.quarantine],
    [navigationRoutes.walkthrough, nav.walkthrough],
  ] as const;
    ...
    <header className="site-header" data-mobile-open={mobileOpen}>
      ...
      <div className="site-header__main page-width">
        ...
        <nav className="primary-nav" aria-label="Primary navigation">
          ...
          <Link href={navigationRoutes.checkpointGuide}>{nav.guides}</Link>
