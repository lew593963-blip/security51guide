...
export const routes = {
  home: "/",
  checkpointGuide: requireGuideRoute("checkpoint-guide"),
  anomalies: requireGuideRoute("anomalies"),
  medicalTests: requireGuideRoute("medical-tests"),
  quarantine: requireGuideRoute("quarantine"),
  walkthrough: requireGuideRoute("walkthrough"),
  about: "/about",
  contact: "/contact",
